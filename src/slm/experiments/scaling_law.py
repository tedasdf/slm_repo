...
if __name__ == "__main__":
    ...
    # print("\n========== DUPLICATE ARCHITECTURE SUMMARY ==========")
    # duplicates = {
    #     k: v for k, v in seen_architectures.items()
    #     if len(v) > 1
    # }

    # if not duplicates:
    #     print("No duplicate architectures found.")
    # else:
    #     for arch, runs in duplicates.items():
    #         print(f"arch={arch} used by {len(runs)} runs")
